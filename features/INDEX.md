...
| PROJ-71 | EEG-Customer-Onboarding (Phase A komplett) — `/customer-onboarding` Public-Form, AGB/AVV-Click-Akzept mit Audit-Trail, AVV-PDF + Confirm-Mail mit Link, Auto-Activate via E-Mail-Confirm-Klick (legt `registration_entrypoint` an), Welcome-Mail, Owner-Notification, Superuser-BackOffice-Liste + Reject-Action, Tenant-Admin-Status-Card im bestehenden `/admin/settings/`. PROJ-74-Scope absorbiert. | In Progress | `features/PROJ-71-customer-onboarding-form-avv-mail.md` | 2026-06-05 |
