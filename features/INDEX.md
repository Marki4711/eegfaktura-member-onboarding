...
| PROJ-69 | Reconciliation-basierter Billing-Backstop — Login-Trigger gegen eegFaktura-Core, Strict-2-Keys-Match (IBAN+E-Mail), setzt faktura_handover_at + MNr-Backfill, global per Config-Flag, Cutoff ab Deploy | In Progress | `features/PROJ-69-billing-reconciliation-backstop.md` | 2026-05-31 |
