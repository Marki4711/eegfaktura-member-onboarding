...
| PROJ-60 | Datenweiterleitung an externe Systeme — Phase 1: Excel/CSV-Export mit konfigurierbarem Spalten-Mapping, getriggert via Bulk-Action (PROJ-25) oder Single aus Detail | Planned | `features/PROJ-60-external-system-sync.md` | 2026-05-23 |
