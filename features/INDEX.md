...
| PROJ-87 | USt-Pflicht-Status in der Antrags-Detail-Ansicht sichtbar machen — Tester-Feedback: in `admin-application-detail.tsx` war der Kleinunternehmer-Status nicht direkt erkennbar; der Admin musste UID-leer ⇒ Kleinunternehmer im Kopf nachvollziehen. Neuer Field-Eintrag "USt-pflichtig: Ja / Nein (Kleinunternehmerregelung)" fuer company + association, Ableitung identisch zum Edit-Form (vatLiable aus UID-Befuellung, kein eigenes DB-Feld pro PROJ-63-Direktive). 5-Zeilen-Frontend-Edit, kein API/DB/Helm-Eingriff. | Approved | `features/PROJ-87-vatliable-status-in-admin-detail.md` | 2026-06-08 | `features/PROJ-84-eeg-settings-auto-save.md` | 2026-06-08 |
